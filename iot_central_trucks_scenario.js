...
const deliverTime = 300; // Time to complete delivery, in seconds. 
const loadingTime = 800; // Time to load contents. 
const dumpingTime = 200; // Time to dump melted contents. 
...
var baseLat = 53.11763003786845; // Base position latitude. 
var baseLon = 18.036945084995434; // Base position longitude. 
...
var customer = [ // Lat/lon position of customers. 
    ...
    // 0
    [53.12063644822188, 18.00371814266684],

    // 1
    [53.122365618475364, 18.000948763558174],

    // 2
    [53.12179259167698, 18.002901411647027],

    // 3
    [53.12295151438199, 18.001120424928622],

    // 4
    [53.121985747631044, 17.999350167045876],

    // 5
    [53.12182478438624, 17.994683123710796],

    // 6
    [53.12266178662507, 18.001002407910427],

    // 7
    [53.122333798021316, 18.000081824809765],

    // 8
    [53.12174145514128, 18.001406836012915],

    // 9
    [53.120147184713716, 18.004270488446494]
];
